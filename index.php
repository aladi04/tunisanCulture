...
<body>
    ...
    <div class="container">
        ...
        <div class="gallery">
            ...
            <?php }} else { echo "<p>No tours available.</p>"; } ?>
        </div>
        ...
        <div class="gallery">
            ...
            <?php }} else { echo "<p>No programs available.</p>"; } ?>
        </div>
        ...
        <h1 class="unicode-text">Reserve a Program</h1>
        <form method="POST" action="reserve_program.php">
