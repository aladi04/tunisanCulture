		...
		<section id="contact"  class="subscription">
			<div class="container">
				<div class="subscribe-title text-center">
					<h2>
						what did you like the most ? give us your thoughts?
					</h2>
					<p>
						We wouldd love to hear your feedback your thoughts are important to us!
					</p>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="subscription-input-group">
							<form action="#">
								<input type="text" class="subscription-input-form">
