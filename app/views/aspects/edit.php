    ...
    <div class="col-md-8 mx-auto">
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <div class="row">
                    <div class="col">
                        <h2 class="card-text">Edit Aspect</h2>
                    </div>
                    <div class="col">
                ...
                <p class="card-text">Please modify the details of the aspect.</p>
            </div>

            <div class="card-body">
                <form method="post" action="<?php echo URLROOT ;?>/aspects/edit/<?php echo $data['id'] ;?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="submit" class="btn btn-primary btn-block pull-left" value="Update Aspect">
                            </div>
                        </div>
                    </div>
                </form>
