    ...
    <div class="col-md-8 mx-auto">
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <div class="row">
                    <div class="col">
                        <h2 class="card-text">Add New Event</h2>
                    </div>
                    <div class="col">
                ...
                <p class="card-text">Please fill out this form to add a new event</p>
            </div>

            <div class="card-body">
                <form method="post" action="<?php echo URLROOT; ?>/events/add" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="image">Image<sub>*</sub></label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="aspect"
                            ...
                            <option value="<?php echo $aspect->id_aspect; ?>"
                                ...
                                <?php echo htmlspecialchars($aspect->categorie); // Remplacez 'categorie' par la colonne appropriée si nécessaire ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block pull-left" value="Add Event">
                    </div>
                </form>
            </div>
        </div>
